      ...
      <div className="flex lg:flex-col gap-2 lg:flex-1 lg:h-full lg:overflow-auto overflow-x-scroll">
        {[...Array(3)].map((_, i) => {
          return (
            <div
              key={i}
              className="animate-pulse w-32 h-24 bg-gray-200 lg:w-full rounded-3xl object-cover flex-1 hover:opacity-80 active:scale-95  "
            />
          );
        })}
      </div>
      <div className="animate-pulse lg:w-2/3 h-96 w-full lg:h-full object-cover bg-gray-200 rounded-2xl" />
